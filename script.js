    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Star Shoes משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('http://localhost:5001/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '1e99be0d-097f-499a-8b5c-6c64c4eb0d21',
                    name: data.name || '',
                    email: data.email || '',
...
/* Integration Scripts */
// setup_contact_form_emails functionality
// Email integration configured for Star Shoes
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const apiUrl = (window.ZAPPY_API_BASE || 'https://qaapi.zappy5.com').replace(/\/$/, '');
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '1e99be0d-097f-499a-8b5c-6c64c4eb0d21';
            ...
            if (mobileToggle && navMenu) {
                ...
                if (phoneHeaderBtn) {
                    phoneHeaderBtn.addEventListener('click', function() {
                        ...
                        // Falls back to 0522972222 placeholder which businessInfoUpdater can replace
      ...
      <div class="product-info">
        ...
        ${(() => {
          ...
          const rowsHtml = upsellsArr.map(u => {
            ...
            const firstImg = (u.images && u.images[0]) ? u.images[0] : '';
            const img = firstImg && window.resolveProductImageUrl ? window.resolveProductImageUrl(firstImg) : firstImg;
            ...
            return '<li class="upsell-row ' + (inStock ? '' : 'is-out-of-stock') + '" data-upsell-id="' + _eA(u.id) + '" data-upsell-price="' + p + '">' +
              '<label class="upsell-row-label">' +
                ...
                (img ? '<img class="upsell-thumb" src="' + _eA(img) + '" alt="' + _eA(u.name || '') + '" loading="lazy" />' : '<span class="upsell-thumb"></span>') +
...
function addCheckedUpsellsToCart() {
  ...
  checkedBoxes.forEach(function (cb) {
    ...
    if (v) {
      const finalPrice = variantPrice !== null
        ? variantPrice
